...
export const extractMethodHandlers = (module: RouteModule, filePath: string): Map<HttpMethod, RouteHandler> => {
...
const hasOpenAPISchema = (schema: Record<string, unknown>): boolean => {
